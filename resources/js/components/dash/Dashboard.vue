      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><router-link :to="{ name: 'dashboard' }"><i class="fa fa-circle-o"></i> Dashboard v1</router-link></li>
          </ul>
        </li>
...
<script>
	export default {
		...
		mounted() {
		  this.toggleBodyClass('addClass', 'skin-blue');
		  this.toggleBodyClass('addClass', 'sidebar-mini');
		},
		destroyed() {
		  this.toggleBodyClass('removeClass', 'skin-blue');
